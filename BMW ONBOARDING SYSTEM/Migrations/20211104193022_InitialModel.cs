    ...
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuizID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuizDescription = table.Column<string>(maxLength: 255, nullable: true),
                    QuizMarkRequirement = table.Column<string>(maxLength: 255, nullable: true),
                    QuizDueDate = table.Column<DateTime>(nullable: true),
                    QuizCompletionDate = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OnboarderCourseEnrollmentID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OnboarderEnrollmentDate = table.Column<DateTime>(nullable: false),
                    OnboarderGraduationDate = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnboarderCourseEnrollment", x => x.OnboarderCourseEnrollmentID);
                    table.ForeignKey(
